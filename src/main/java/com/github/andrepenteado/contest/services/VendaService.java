...
import com.github.andrepenteado.contest.entity.AliquotaImposto;
...
import com.github.andrepenteado.contest.entity.ImpostoNotaFiscal;
import com.github.andrepenteado.contest.entity.ItemCompra;
import com.github.andrepenteado.contest.entity.ItemVenda;
import com.github.andrepenteado.contest.entity.NFe;
...
public class VendaService extends BasicService {
    ...
    public List<Venda> pesquisarVendasNaoEmitidas() {
        ...
        hql.append("SELECT v FROM com.github.andrepenteado.contest.entity.Venda v ");
        hql.append("WHERE NOT EXISTS ( ");
        hql.append("   SELECT nf FROM com.github.andrepenteado.contest.entity.NotaFiscal nf ");
        hql.append("   WHERE nf.venda.id = v.id ");
        hql.append(") ");
        hql.append("AND NOT EXISTS ( ");
        hql.append("   SELECT o FROM com.github.andrepenteado.contest.entity.Orcamento o ");
    ...
    public void excluirPedidoVenda(Venda venda) throws ServiceValidationException {
        ...
        hql.append("   SELECT iv.id FROM com.github.andrepenteado.contest.entity.ItemVenda iv ");
    ...
    public List<ItemVenda> pesquisarItensVendidosPorCliente(long idCliente) {
        ...
        hql.append("FROM com.github.andrepenteado.contest.entity.ItemVenda item ");
    ...
    public long buscarProximoNumeroNotaFiscal() {
        StringBuilder hql = new StringBuilder();
        hql.append("SELECT MAX(nf.numero) + 1 FROM com.github.andrepenteado.contest.entity.NotaFiscal nf ");
        ...
        if (userLogin.getFuncionario().getEmpresa().getConfiguracao().getSituacaoNfe().intValue() > 0)
            hql.append("AND nf.id IN (SELECT nfe.notaFiscal.id FROM com.github.andrepenteado.contest.entity.NFe nfe)");
    ...
    public String verificarAvisosVenda(Venda venda) {
        ...
        hql1.append("SELECT COUNT(v.id) FROM com.github.andrepenteado.contest.entity.Venda v ");
        hql1.append("WHERE v.cliente.id = :pIdCliente ");
        hql1.append("AND ( ");
        hql1.append("   v.id IN (SELECT nf.venda.id FROM com.github.andrepenteado.contest.entity.NotaFiscal nf) ");
        hql1.append("   OR v.id IN (SELECT o.venda.id FROM com.github.andrepenteado.contest.entity.Orcamento o) ");
        hql1.append(") ");
    ...
    private String verificarAvisosItemVenda(ItemVenda itemVenda) {
        ...
        StringBuilder hql = new StringBuilder();
        hql.append("SELECT iv FROM com.github.andrepenteado.contest.entity.ItemVenda iv ");
    ...
    public void cancelarNotaFiscal(NotaFiscal notaFiscal) throws ServiceValidationException {
        try {
            ...
            // Excluir comissão
            executeUpdate("DELETE FROM com.github.andrepenteado.contest.entity.Comissao c WHERE c.venda.id = :pIdVenda", new Object[][] { { "pIdVenda",
                            notaFiscal.getVenda().getId() } });

            // Excluir os recebimentos
            executeUpdate("DELETE FROM com.github.andrepenteado.contest.entity.Recebido rb WHERE rb.receber.id IN (SELECT r.id FROM com.github.andrepenteado.contest.entity.Receber r WHERE r.venda.id = :pIdVenda)",
                            new Object[][] { { "pIdVenda", notaFiscal.getVenda().getId() } });
            executeUpdate("DELETE FROM com.github.andrepenteado.contest.entity.Receber r WHERE r.venda.id = :pIdVenda", new Object[][] { { "pIdVenda",
                            notaFiscal.getVenda().getId() } });
    ...
    public void estornarNotaFiscal(NotaFiscal notaFiscal) throws ServiceValidationException {
        ...
        try {
            ...
            // Excluir comissão
            executeUpdate("DELETE FROM com.github.andrepenteado.contest.entity.Comissao c WHERE c.venda.id = :pIdVenda",
                            new Object[][] { { "pIdVenda", venda.getId() } });

            // Excluir os recebimentos
            executeUpdate("DELETE FROM com.github.andrepenteado.contest.entity.Recebido rb WHERE rb.receber.id IN (SELECT r.id FROM com.github.andrepenteado.contest.entity.Receber r WHERE r.venda.id = :pIdVenda)",
                            new Object[][] { { "pIdVenda", venda.getId() } });
            executeUpdate("DELETE FROM com.github.andrepenteado.contest.entity.Receber r WHERE r.venda.id = :pIdVenda",
                            new Object[][] { { "pIdVenda", venda.getId() } });

            // Excluir NFe, caso exista
            if (notaFiscal.getVenda().getEmpresa().getConfiguracao().getSituacaoNfe().intValue() > 0)
                executeUpdate("DELETE FROM com.github.andrepenteado.contest.entity.NFe nfe WHERE nfe.notaFiscal.id IN (SELECT nf.id FROM com.github.andrepenteado.contest.entity.NotaFiscal nf WHERE nf.venda.id = :pIdVenda)",
                                new Object[][] { { "pIdVenda", notaFiscal.getVenda().getId() } });

            // Excluir os registros de movimentos de estoque
            executeUpdate("DELETE FROM com.github.andrepenteado.contest.entity.MovimentoEstoque me WHERE me.itemVenda.id IN (SELECT iv.id FROM com.github.andrepenteado.contest.entity.ItemVenda iv WHERE iv.venda.id = :pIdVenda)",
                            new Object[][] { { "pIdVenda", venda.getId() } });
    ...
    public Integer buscarAnoInicioVendas() {
        return ((List<Integer>)executeQuery("SELECT MIN(YEAR(v.dataLancamento)) FROM com.github.andrepenteado.contest.entity.Venda v", null)).get(0);
    }
    ...
    public List<Object[]> pesquisarProdutosVendidosPorCidade(Date dataInicial, Date dataFinal, String cidade, int ordenacao) {
        ...
        hql.append("FROM com.github.andrepenteado.contest.entity.ItemVenda iv ");
    ...
    public List<Object[]> pesquisarProdutosVendidosPorVendedor(Date dataInicial, Date dataFinal, Funcionario funcionario, int ordenacao) {
        ...
        hql.append("FROM com.github.andrepenteado.contest.entity.Comissao c, IN(c.venda.itens) iv ");
    ...
    public List<Recebido> pesquisarRecebimentosPorCaixa(long idCaixa) {
        ...
        StringBuilder hql = new StringBuilder();
        hql.append("SELECT r ");
        hql.append("FROM com.github.andrepenteado.contest.entity.Recebido r ");
    ...
    public List<Object[]> pesquisarTotalVendidoCaixaPorPeriodo(Date dataInicial, Date dataFinal) {
        ...
        hql.append("FROM com.github.andrepenteado.contest.entity.Caixa AS c ");
    ...
    public Caixa buscarCaixaAbertoPorFuncionario(Funcionario funcionario) {
        ...
        StringBuilder hql = new StringBuilder();
        hql.append("SELECT c ");
        hql.append("FROM com.github.andrepenteado.contest.entity.Caixa c ");
