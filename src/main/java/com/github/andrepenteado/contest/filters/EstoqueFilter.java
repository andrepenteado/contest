...
public class EstoqueFilter<T> extends BasicFilter {
    ...
    private void adicionarFrom() {
        if (classeGenerica.isInstance(new MovimentoEstoque())) {
            filterDescription.append("SELECT me FROM com.github.andrepenteado.contest.entity.MovimentoEstoque me ");
            ...
            filterDescription.append("SELECT e FROM com.github.andrepenteado.contest.entity.Estoque e ");
            filterDescription.append("WHERE 1 = 1 ");
        }
    }
