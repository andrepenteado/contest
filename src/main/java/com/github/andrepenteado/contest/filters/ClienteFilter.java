...
public class ClienteFilter extends BasicFilter {
    ...
    public void createFilter() {
        ...
        filterDescription.append("SELECT c FROM com.github.andrepenteado.contest.entity.Cliente c ");
    ...
    private void adicionarVendedor() {
        if (vendedor != null) {
            ...
            filterDescription.append("   SELECT v.cliente FROM com.github.andrepenteado.contest.entity.Venda v ");
