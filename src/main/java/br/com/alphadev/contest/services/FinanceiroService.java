...
import br.com.alphadev.contest.entity.ContaCorrente;
...
public class FinanceiroService extends BasicService {
    ...
    public List<Object[]> pesquisarContasPorTipoPorPeriodo(Date dataInicial, Date dataFinal, int[] idsTiposConta, char periodicidade, char situacao) {
        ...
        if (situacao == 'R') { // Receber
            ...
            sb.append("(SELECT descricao FROM br.com.alphadev.contest.entity.TipoConta WHERE id = r.tipoConta.id) ");
            sb.append(", SUM(r.valor) FROM br.com.alphadev.contest.entity.Receber r ");
            ...
            sb.append("SELECT ").append(aggregate).append(", ");
            sb.append("(SELECT descricao FROM br.com.alphadev.contest.entity.TipoConta WHERE id = p.tipoConta.id) ");
            sb.append(", SUM(p.valor) FROM br.com.alphadev.contest.entity.Pagar p ");
            ...
            sb.append("SELECT ").append(aggregate).append(", ");
            sb.append("(SELECT descricao FROM br.com.alphadev.contest.entity.TipoConta WHERE id = r.receber.tipoConta.id) ");
            sb.append(", SUM(r.valorPago) FROM br.com.alphadev.contest.entity.Recebido r ");
            ...
            sb.append("SELECT ").append(aggregate).append(", ");
            sb.append("(SELECT descricao FROM br.com.alphadev.contest.entity.TipoConta WHERE id = p.pagar.tipoConta.id) ");
            sb.append(", SUM(p.valorPago) FROM br.com.alphadev.contest.entity.Pago p ");
