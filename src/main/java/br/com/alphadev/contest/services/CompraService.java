...
public class CompraService extends BasicService {
    ...
    public void excluirPedidoCompra(Compra compra) throws ServiceValidationException {
        ...
        hql.append("   SELECT ic.id FROM br.com.alphadev.contest.entity.ItemCompra ic ");
    ...
    public void estornarCompraEmitida(Compra compra) throws ServiceValidationException {
        try {
            ...
            executeUpdate("DELETE FROM br.com.alphadev.contest.entity.Pago pg WHERE pg.pagar.id IN (SELECT p.id FROM br.com.alphadev.contest.entity.Pagar p WHERE p.compra.id = :pIdCompra)",
                            new Object[][] { { "pIdCompra", compra.getId() } });
            executeUpdate("DELETE FROM br.com.alphadev.contest.entity.Pagar p WHERE p.compra.id = :pIdCompra",
                            new Object[][] { { "pIdCompra", compra.getId() } });
    ...
    public List<ItemCompra> pesquisarItensCompradosPorFornecedor(long idFornecedor) {
        ...
        hql.append("FROM br.com.alphadev.contest.entity.ItemCompra item ");
    ...
    public Compra buscarNotaFiscalCompraPorFornecedor(long nf, Fornecedor fornecedor) {
        ...
        sb.append("SELECT c FROM br.com.alphadev.contest.entity.Compra c ");
    ...
    public List<Compra> pesquisarComprasNaoEmitidas() {
        ...
        hql.append("FROM br.com.alphadev.contest.entity.Compra compra ");
