...
public class VendaFilter<T> extends BasicFilter {
    ...
    private void adicionarFrom() {
        if (classeGenerica.isInstance(new Venda())) {
            filterDescription.append("SELECT v FROM br.com.alphadev.contest.entity.Venda v ");
            filterDescription.append("WHERE 1 = 1 ");
        }
        else if (classeGenerica.isInstance(new NotaFiscal())) {
            filterDescription.append("SELECT nf FROM br.com.alphadev.contest.entity.NotaFiscal nf ");
            filterDescription.append("WHERE 1 = 1 ");
        }
        else if (classeGenerica.isInstance(new Orcamento())) {
            filterDescription.append("SELECT o FROM br.com.alphadev.contest.entity.Orcamento o ");
            filterDescription.append("WHERE 1 = 1 ");
        }
        else if (classeGenerica.isInstance(new Comissao())) {
            filterDescription.append("SELECT c FROM br.com.alphadev.contest.entity.Comissao c ");
            filterDescription.append("WHERE 1 = 1 ");
        }
        else if (classeGenerica.isInstance(new Receber())) {
            filterDescription.append("SELECT r FROM br.com.alphadev.contest.entity.Receber r ");
            ...
            filterDescription.append("   FROM br.com.alphadev.contest.entity.Recebido rb1 ");
            ...
            filterDescription.append("   FROM br.com.alphadev.contest.entity.Receber r2 ");
            filterDescription.append("   WHERE NOT EXISTS ELEMENTS(r2.recebimentos) ");
            filterDescription.append(") ");*/
        }
        else if (classeGenerica.isInstance(new Recebido())) {
            filterDescription.append("SELECT r FROM br.com.alphadev.contest.entity.Recebido r WHERE 1 = 1 ");
        }
    }
    ...
    private void adicionarEmissao() {
        if (classeGenerica.isInstance(new Venda())) {
            if (dataEmissaoInicial != null) {
                ...
                filterDescription.append("      SELECT nf.venda.id FROM br.com.alphadev.contest.entity.NotaFiscal nf ");
                filterDescription.append("      WHERE nf.emissao >= :pDataEmissaoInicial ");
                filterDescription.append("   ) OR v.id IN ( ");
                filterDescription.append("      SELECT o.venda.id FROM br.com.alphadev.contest.entity.Orcamento o ");
    ...
    private void adicionarVencimento() {
        if (classeGenerica.isInstance(new Venda())) {
            if (dataVencimentoInicial != null) {
                ...
                filterDescription.append("   SELECT r.venda.id FROM br.com.alphadev.contest.entity.Receber r ");
    ...
    private void adicionarNumeroVenda() {
        if (numeroVenda > 0) {
            if (classeGenerica.isInstance(new Venda())) {
                ...
                filterDescription.append("      FROM br.com.alphadev.contest.entity.NotaFiscal nf ");
                filterDescription.append("      WHERE nf.numero = :pNumeroVenda ");
                filterDescription.append("   ) ");
                filterDescription.append("   OR v.id IN (");
                filterDescription.append("      SELECT o.venda.id ");
                filterDescription.append("      FROM br.com.alphadev.contest.entity.Orcamento o ");
