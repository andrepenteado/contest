...
<c:set var="linkPesquisar"><%=request.getContextPath()%>/cadastros/cliente.vendas.action</c:set>
...
<body>
  <center>
  <display:table name="listaVendas" pagesize="50" export="false" id="venda" requestURI="${linkPesquisar}">
    ...
    <display:column property="funcionario.nome" title="Vendedor"/>
